...
T CoreFrequencyDomainFeatures<T>::spectralRolloff(const std::vector<T> &magnitudeSpectrum,
                                                  T percentile) {
    T sumOfMagnitudeSpectrum = std::accumulate(magnitudeSpectrum.begin(), magnitudeSpectrum.end(),
                                               0);
...
//===========================================================
template
class CoreFrequencyDomainFeatures<float>;

template
class CoreFrequencyDomainFeatures<double>;
